...
pub use inspect::{
    ...
    inspect_project_envelope, inspect_rust_project, inspect_rust_sources, AmariDependencyEvidence,
    BenchmarkEvidence, BenchmarkStatus, CargoBench, CargoBuildSettings, CargoDependencyRecord,
    CargoInspection, CargoInspectionWarning, CargoLock, CargoPackage, CargoPlatformInspection,
    ...
    CustomTargetEvidence, DependencyKind, InspectionLimit, InspectionLimits, LockedPackage,
    ManifestSource, NativeLink, NativeRequirement, NoStdEvidence, NoStdPackageEvidence,
    NpmDependencyEvidence, NpmDependencyKind, NpmInspection, NpmInspectionWarning, NpmLock,
    NpmLockedPackage, NpmPackage, NpmSource, ProjectInspector, ProjectKind, ProjectSignal,
    ProjectSnapshot, RustCfgEvidence, RustCrateAttribute, RustFileKind, RustInspectionWarning,
    RustSourceInspection, RustUsage, RustUsageKind, RustflagCategory, RustflagCategoryCount,
    RustflagsEvidence, RustflagsScope, SnapshotState, SourceLocation, SystemDependencyKind,
    SystemDependencySignal, TargetCfgConstraint, TargetCfgSource, VocabularyEvidence,
    WasmTargetEvidence, WasmTargetOrigin, WorkspaceDependencyBase, WorkspaceMeta,
};
pub use protocol::{
