...
SHARDS: dict[str, tuple[str, ...]] = {
    ...
    "planner": (
        ...
        "probe_output",
        "probe_rewrite_infer",
        "probe_rewrite_inverse_search",
        "probe_rewrite_languages",
        "probe_rewrite_normalize",
        "probe_rewrite_predecessors",
        "probe_rewrite_relations",
        "probe_surreal",
        "probe_tropical",
        "probe_worker_protocol",
        "rewrite_discovery_inverse_search",
        "rewrite_discovery_languages",
        "rewrite_discovery_macros",
        "rewrite_discovery_relations",
        "shell",
