...
| `probabilistic` | `amari-probabilistic` | `pub mod probabilistic`, crate-root re-exports | GPU-backed sampling/statistics with validation and public tests; GB10/RTX 5080 validation passed; crossover validation pending |
