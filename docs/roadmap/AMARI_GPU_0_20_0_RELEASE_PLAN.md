...
The 0.20.0 goal is the validated `amari-gpu` stabilization baseline. Follow-up GPU issues are deferred to the 0.25.0 GPU/Borsalino modernization cycle rather than a planned 0.20.1 fast-follow:
